# -*- coding: utf-8 -*-
"""head_and_sholders.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1sOfU9Le_iReNyn0N3sAlLH7oAOARE9aV
"""
...
i = 0
while i <= len(t)-1:
  a = yf.download(t[i], start="2021-06-07", end="2021-06-21")
  b = yf.download(t[i], start="2021-06-21", end="2021-07-03")
  c = yf.download(t[i], start="2021-07-05", end="2021-07-19")
  closeA = a["Close"]
  closeB = b["Close"]
  closeC = c["Close"]
  amin = min(closeA)
  ...
  bmax = max(closeB)
  cmax = max(closeC)
  k1 = amin/cmin #отношение минимумов левого и правого плеча
  k2 = amax/cmax #отношение максимумов левого и правого плеча (Линия шеи)
  k3 = amin/bmin #отношение минимума левого плеча и вершины
  k4 = cmin/bmin #отношение минимума правого плеча и врешины
  if k1 <= 1.02 and k2 >= 0.98 and k2 <= 1.02 and k3 >=1.01 and k4 >=1.01:
    print(t[i])
    k[len(k):] = [t[i]]
    print(k)
    print(k1, k2, k3, k4)
